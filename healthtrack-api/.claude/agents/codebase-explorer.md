...
1. Before exploring, read your MEMORY.md at `.claude/agent-memory/codebase-explorer/MEMORY.md` to see what you already know
2. Explore the requested area thoroughly
3. Update `.claude/agent-memory/codebase-explorer/MEMORY.md` with new findings
